...
describe('Site Tests', () => {
  ...
  it('Should register a new user', () => {
    ...
    // Select the username input and type the faek name@test.com
    ...
    // You should be able to selecy the header on the dashboard that contains the text your pets
  ...
  it('Shouls add a post for a pet', () => {
